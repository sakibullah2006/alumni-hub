...
import { exampleImages } from "@/data/dummy/exampleImages"
...
const HeroSection = () => {
    ...
    return (
        <div
            className="flex w-dvw h-96 justify-center items-center bg-muted-foreground overflow-hidden"
            ref={scope}
        >
            <motion.div
            ...
            >
                <p className="text-4xl sm:text-5xl md:text-7xl z-50 text-accent font-serif italic">
                    DSKM Alumni Hub
                </p>
                <Link
                    href={ROUTES.ALUMNIES}
                    className="text-xl z-50 hover:scale-110 transition-transform bg-background text-primary rounded-full py-3 w-26 cursor-pointer"
                >
                    Explore
                </Link>
            </motion.div>
