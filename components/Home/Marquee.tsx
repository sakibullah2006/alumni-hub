...
export default function MarqueeSection() {
    ...
    return (
        <div
            className="flex w-dvw min-h-[75vh] md:mt-20 relative justify-center items-center flex-col bg-background overflow-hidden"
            ref={setContainer}
        >
            <h1 className="text-center text-3xl sm:text-5xl md:text-6xl text-foreground font-serif mb-8">
                Our Alumnies
            </h1>
            <div className="w-full justify-center items-center flex flex-col space-y-2 sm:space-y-3 md:space-y-4">
                {container && (
                    <>
                        <SimpleMarquee
                            className="w-full"
